  ...
  return (
    <div className="conocenos-web">
      ...
      <div className="container">
        <div onClick={handleregresarClick} className="image-19"></div>
        ...
        <div className="frame-2610367">
          <span className="bienvenido-ala-seccin-concenos-permteme-presentarte-alos-creadores-detrs-de-esta-plataforma-somos-un-equipo-apasionado-de-desarrolladores-dedicados-aproporcionarte-la-mejor-experiencia-de-aprendizaje-en-lnea-desde-el-diseo-hasta-la-implementacin-hemos-trabajado-arduamente-para-crear-una-plataforma-que-se-adapte-atus-necesidades-educativas-esperamos-que-disfrutes-de-lo-que-hemos-creado-para-ti">
            ¡Bienvenido a la sección &#39;Conócenos&#39;! Permíteme presentarte
            a los creadores detrás de esta plataforma. Somos un equipo
            apasionado de desarrolladores dedicados a proporcionarte la mejor
            experiencia de aprendizaje en línea. Desde el diseño hasta la
            implementación, hemos trabajado arduamente para crear una plataforma
            que se adapte a tus necesidades educativas. ¡Esperamos que disfrutes
            de lo que hemos creado para ti!
          </span>
          <img
        ...
        <div className="large-grid">
          ...
          <div className="card-1">
            ...
            <div className="copy-1">
              <span className="manuel-afatama-r">Manuel A. Fatama R.</span>
              <span className="arquitecto-cloud">Arquitecto Cloud</span>
            </div>
          </div>
          <div className="card-2">
            <div className="image-1"></div>
            <div className="copy-2">
              <span className="bruno-gcipriano-a">Bruno G. Cipriano A.</span>
              <span className="desarrollador-web">Desarrollador WEB</span>
            </div>
          </div>
        </div>
